...
public class Input {
    public static final int DESCARTABLE = 0, SALTO_LINEA = 1, LETRA_MINUSC = 2, D_MINUSC = 3, U_MINUSC = 4, I_MINUSC = 5,
        ...
        SUMA = 14, GUION = 15, MULTIPL = 16, DIV = 17, CORCHETE_A = 18, CORCHETE_C = 19, PARENT_A = 20, PARENT_C = 21,
    ...
    public static int charToInt(char inputChar){
        switch (inputChar){
            case '\t':
            case ' ': return DESCARTABLE;
            case '\n': return SALTO_LINEA;
            case 'd': return D_MINUSC;
            case 'u': return U_MINUSC;
            case 'i': return I_MINUSC;
            case '_': return GUION_B;
            ...
            case '*': return MULTIPL;
            case '/': return DIV;
            case '{': return CORCHETE_A;
            case '}': return CORCHETE_C;
            case '(': return PARENT_A;
            case ')': return PARENT_C;
            case '.': return PUNTO;
            case ',': return COMA;
